...
export default function Aboutpage() {
  return (
    <>
      ...
      <main className="min-h-screen bg-slate-900 text-gray-100 py-12 px-4">
        <div className="max-w-4xl mx-auto bg-gradient-to-b from-slate-800 to-slate-900 rounded-2xl shadow-lg p-8">
